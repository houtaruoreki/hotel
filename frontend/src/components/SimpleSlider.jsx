...
export default function SimpleSlider() {
  ...
  const slideContent = (
    <div className="absolute top-1/2 left-1/4 transform -translate-x-1/2 -translate-y-1/2 text-left z-10 font-bold ">
      ...
      <Link
        to="/Reservation"
        className="p-[16px] bg-[#f2f9f1] rounded-md border text-black border-black hover:bg-mwvane transition duration-300 ease-in-out flex items-center justify-center w-[50%] md:w-[200px]"
      >
        დაჯავშნე ოთახი
